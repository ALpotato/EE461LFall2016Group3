                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="j" begin="0" end="4">
                                ...
                                <div id="Scores">
                                    <p>Score: ${leaderBoard[i].scoreList[j].score}</p>
                                    <p>Perfect: ${leaderBoard[i].scoreList[j].perfect}</p>
                                    <p>Great: ${leaderBoard[i].scoreList[j].great}</p>
                                    <p>Good: ${leaderBoard[i].scoreList[j].good}</p>
                                    <p>Bad: ${leaderBoard[i].scoreList[j].bad}</p>
                                    <p>Miss: ${leaderBoard[i].scoreList[j].miss}</p>
                                    <p>Max Combo: ${leaderBoard[i].scoreList[j].maxCombo}</p>
                                </div>
                            </c:forEach>
                        </c:otherwise>
                    </c:choose>
